...
export default class RegisterComponent extends BasePage{
  ...
  private readonly registerElements = {
    ...
    // personalInfoOption: `ul.dropdown-menu.dropdown-menu-right li a[href*="Personal Info"]`,
    personalInfoOption: `//ul[@class='dropdown-menu dropdown-menu-right']//a[normalize-space()='Personal Info']`,
    // #navigation > div.navigation-header > div > div > div > div.pull-right > div > div.bto-user-logged > div.btn-group.personal.open > ul > li:nth-child(1) > a
    // div[class='navigation-header'] li:nth-child(1) a:nth-child(1)
    //a[href="https://qa.btobet.net/player-portal/#personal"][text="Personal Info"]
    userFirstNameInputValue: `input[name="FirstName"]`
   
  }


  // async fillInFirstName1(user:string) {
  //   await this.page.locator(this.registerElements.firstnameInput).fill(user);
  // }
